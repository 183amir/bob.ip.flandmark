...
public:
	 ...
	 * @param ground_truth
	 */
	virtual void update(DOUBLE * const w, DOUBLE *g, cimg_library::CImg<unsigned char> *image_data, int * const ground_truth=0);
	 ...
	 * @param index
	 */
	virtual void dotProductWithWg(DOUBLE * const w, DOUBLE *g, const int index) = 0;
	 ...
	 * @return
	 */
	virtual DOUBLE getGvalue(int * const s_i, int * const s_j, DOUBLE * const w) = 0;

	/**
	 * @brief write
	 * @param fs
	 */
	virtual void write(XmlStorage &fs, DOUBLE * const w, bool writeW=true) = 0;
