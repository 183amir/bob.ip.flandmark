...
public:
	...
	Flandmark(
		...
		DOUBLE base_window_margin_x=1.2,
		DOUBLE base_window_margin_y=1.2
	);
	 ...
	 * @return
	 */
	cimg_library::CImg<unsigned char> * getNF(cimg_library::CImg<unsigned char> *img, int * const bbox, DOUBLE * const ground_truth=0);
	 ...
	 * @return
	 */
	cimg_library::CImg<unsigned char> * getNFgeneralBB(cimg_library::CImg<unsigned char> *img, int * const bbox, DOUBLE * const ground_truth=0);
	 ...
	 * @return
	 */
	inline DOUBLE * getGroundTruth(void)
